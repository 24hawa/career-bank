...
<head>
    ...
    <title>Career DNA Employer — @yield('title', 'Dashboard')</title>
...
<div class="employer-layout">
    ...
    <aside class="sidebar">
        <div class="sidebar-logo">
            ...
            <div>
                <div class="sidebar-brand">Career DNA</div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('employer.dashboard') }}"
               class="sidebar-item {{ request()->routeIs('employer.dashboard') ? 'active' : '' }}">
                <i class="ti ti-layout-dashboard"></i> Dashboard
            </a>

            <div class="sidebar-section">Jobs</div>
            <a href="{{ route('employer.jobs.create') }}"
               class="sidebar-item {{ request()->routeIs('employer.jobs.create') ? 'active' : '' }}">
                <i class="ti ti-plus"></i> Post a Job
            </a>
            <a href="{{ route('employer.jobs.index') }}"
               class="sidebar-item {{ request()->routeIs('employer.jobs.index') ? 'active' : '' }}">
                <i class="ti ti-briefcase"></i> My Listings
            </a>

            <div class="sidebar-section">Talent</div>
            <a href="{{ route('employer.candidates') }}"
               class="sidebar-item {{ request()->routeIs('employer.candidates') ? 'active' : '' }}">
                <i class="ti ti-users"></i> Browse Candidates
            </a>
            <a href="{{ route('employer.applicants') }}"
               class="sidebar-item {{ request()->routeIs('employer.applicants') ? 'active' : '' }}">
                <i class="ti ti-file-check"></i> Applicants
            </a>
