...
{{-- Toast (shown when redirected from Career Identify) --}}
@if(request('career'))
<div class="toast" id="redirect-toast">
    ...
    <div>
        ...
        <div class="toast-sub">Showing jobs matching your Career DNA — {{ ucwords(str_replace('-',' ', request('career'))) }}</div>
    </div>
    ...
    <div class="grid-2" style="grid-template-columns: 2fr 1fr; gap: 24px">
        ...
        <div>
            <div class="card" style="margin-bottom:14px">
                ...
                @if(request('career'))
                <div class="form-group" style="margin-bottom:14px">
                    <label class="form-label">Career DNA filter</label>
