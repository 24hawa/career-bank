...
<div class="page">
    ...
    <div style="margin-bottom:24px">
        <div style="font-size:22px;font-weight:600;color:var(--text);margin-bottom:4px">
            Welcome back, {{ auth()->user()->name ?? 'Shafiena' }} 👋
        </div>
    ...
    <div class="grid-2" style="margin-bottom:24px">
        ...
        {{-- IDENTIFY CAREER CARD --}}
        <div class="feature-card highlight" onclick="showModal('identify-modal')">
            ...
            <div class="feature-card-step">Step 1</div>
        ...
        <div class="feature-card" onclick="window.location='{{ route('candidate.jobs') }}'">
            ...
            <div class="feature-card-step">Step 2</div>
            <div class="feature-card-title">Find Jobs</div>
            <div class="feature-card-desc">
        ...
        {{-- CAREER MATCHES CARD --}}
        <div class="feature-card" onclick="window.location='{{ route('candidate.results') }}'">
            <div class="feature-card-icon" style="background:rgba(26,51,32,0.5)">
                <i class="ti ti-list-search" style="color:var(--muted)"></i>
            </div>
            <div class="feature-card-step">Step 3</div>
            ...
            <a href="{{ route('candidate.results') }}" class="btn btn-outline btn-sm"
               onclick="event.stopPropagation()">
                <i class="ti ti-arrow-right"></i> Go
            </a>
        </div>
        ...
        <div class="feature-card" onclick="window.location='{{ route('candidate.applications') }}'">
            <div class="feature-card-icon" style="background:rgba(26,51,32,0.5)">
                <i class="ti ti-file-description" style="color:var(--muted)"></i>
            </div>
            <div class="feature-card-step">Step 4</div>
            ...
            <a href="{{ route('candidate.applications') }}" class="btn btn-outline btn-sm"
               onclick="event.stopPropagation()">
                <i class="ti ti-arrow-right"></i> Go
            </a>
        </div>
